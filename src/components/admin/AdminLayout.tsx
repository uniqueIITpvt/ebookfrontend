...
const navigation = [
  ...
  { name: 'Free Summaries', href: '/admin/free-summaries', icon: AutoStories },
  { name: 'Trending Books', href: '/admin/trending-books', icon: TrendingUp },
  { name: 'Premium Summaries', href: '/admin/premium-summaries', icon: Stars },
