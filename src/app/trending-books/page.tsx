  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        const data = await trendingBooksApi.getTrendingBooks({ limit: 100 });
        if (data.data) {
          setBooks(data.data);
          const uniqueCategories = [...new Set(data.data.map((b: TrendingBook) => b.category))];
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          <div className="flex items-center justify-center min-h-[400px]">
            <div className="text-center">
              ...
              <h3 className="text-xl font-semibold text-gray-900 mb-2">Error Loading Trending Books</h3>
    ...
    <div className='min-h-screen bg-gray-50 pt-20'>
      <div className="max-w-[1600px] mx-auto">
        ...
        <div className="px-4 sm:px-6 lg:px-8 py-6">
          ...
          <h1 className="text-3xl font-bold text-slate-900">Trending Books</h1>
        </div>
            ...
            <div className='grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6'>
              {filteredItems.length === 0 ? (
                <div className='col-span-full text-center py-12'>
                  <p className='text-slate-600'>No trending books found.</p>
                </div>
              ) : (
